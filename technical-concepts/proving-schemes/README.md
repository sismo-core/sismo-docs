...
When users connect to applications via zkConnect or mint Badges, they participate in a proving scheme to verify ownership of Data Gems (i.e, personal data) in their Data Vault.
...
* [Hydra S2 proving scheme](hydra-s2.md) — [zkConnect](../../what-is-sismo/zkconnect.md)
