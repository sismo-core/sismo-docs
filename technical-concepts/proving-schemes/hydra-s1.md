...
{% hint style="info" %}
Sismo’s [ZK Badge protocol](../../technical-documentation/zk-badge-protocol/) uses Hydra S1 Attesters to issue ZK Badges. You can see Sismo’s Hydra S1 attesters on GitHub [here](https://github.com/sismo-core/sismo-protocol/tree/main/contracts/attesters/hydra-s1).
{% endhint %}
