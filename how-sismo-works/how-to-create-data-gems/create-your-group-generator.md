...
In order to create a Group, we need to build a [Group Generator](../resources/sismo-hub/sismo-protocol-overview.md). This tutorial will guide you through the process of creating one.
...
* [Data Providers](../resources/sismo-hub/data-providers.md) (e.g. [proof-of-humanity](https://github.com/sismo-core/sismo-hub/blob/main/group-generators/generators/proof-of-humanity/index.ts))
...
To fetch all the accounts we want, you will use the 2 different [Data Providers](../resources/sismo-hub/data-providers.md):
...
Finally, you should see what is displayed on the screenshot in [#tutorial-use-case](create-your-group-generator.md#tutorial-use-case "mention")
