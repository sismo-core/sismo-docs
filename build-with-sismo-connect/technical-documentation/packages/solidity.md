...
The `verify()` function allows you to verify a proof generated by the [Sismo Vault app](../../../how-sismo-works/technical-concepts/data-gems-and-data-groups.md) with respect to some requests.
...
* `responseBytes` _(required)_: The response sent back by the [Data Vault](../../../how-sismo-works/technical-concepts/data-gems-and-data-groups.md). It contains the `appId`, the `namespace`, the `version` and the proofs corresponding to the requests made in the frontend.
