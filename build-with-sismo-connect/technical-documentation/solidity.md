...
The `verify()` function allows you to verify a proof generated by the [Sismo Vault app](../../what-is-sismo/personal-data-sismos-data-vault-gems-and-groups.md) with respect to some requests.
