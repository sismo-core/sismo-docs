...
Here is an example of a customized `AuthRequest` that, [when requested](sismoconnect-client-request.md#request), will generate a proof containing a Github Id. The user should have a GitHub in his vault.
